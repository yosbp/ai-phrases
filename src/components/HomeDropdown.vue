<template>
    <div class="absolute z-1 top-8 right-10 md:right-16 md:top-11 ">
        <a-dropdown :trigger="['click']" :overlayStyle="{ backgroundColor: 'transparent' }">
            <a class="ant-dropdown-link" @click.prevent>
                <svg height="25px" width="25px" version="1.1" id="_x36_" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <g>
                            <g>
                                ...
                                <path style="opacity:0.5;fill:#FFFFFF;"
            ...
            <template #overlay>
                <a-menu>
                    <a-menu-item key="0">
                        <a @click="showModal">Share Your Phrase <smile-outlined /></a>
                    </a-menu-item>
                    <a-menu-item key="1">
                        <router-link :to="{ name: 'Docs' }">API</router-link>
                    </a-menu-item>
                    <a-menu-item key="2">
                        <a v-if="lang == 'en'" @click="setLang('es')">Spanish</a>
                        <a v-else @click="setLang('en')">English</a>
                    </a-menu-item>
                </a-menu>
            </template>
        </a-dropdown>
    </div>
    <home-modal-new-phrase v-if="visible" :visible="visible" @hideModal="hideModal" />
</template>

<script setup>
import { ref } from 'vue'
import HomeModalNewPhrase from './HomeModalNewPhrase.vue'
