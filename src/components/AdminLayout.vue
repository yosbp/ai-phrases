<template>
    <div class="dark">
        <div
            class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray- text-black dark:text-white">
                    ...
                    <ul class="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            <router-link :to="{ name: 'NewPhrase' }"
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">New Phrase</span>
                            </router-link>
                        </li>
                        <li>
                            <a href=""
            ...
            <div class="h-full ml-20 me-10 mt-20 mb-10 md:ml-72 ml">
